...
// if the target (whatever you put the event listener on) is an input box, "e.target" has a ".value" property. 
//And it's whatever is in the input box. 
// Even if your input box is type="number", the value will be a string. 
//Like, "243" vs 243. Remember, "1" + "1" === "11"
    ...
    input.addEventListener("change", function(e){
        console.log('lol');
        var string = document.getElementById("change-me").value;
        //string.replace(/[^a-zA-z0-9-. ]/g, "");
       var p = string.replace(/\s/g, "");
       var q = p.replace(/[^a-zA-z0-9-. ]/g, "");
        console.log(q);
        //document.getElementById("output").textContent = e.target.input;
